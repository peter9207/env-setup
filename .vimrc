...
autocmd Filetype ruby setlocal tabstop=8 softtabstop=0 expandtab shiftwidth=2 smarttab
...
augroup go
  ...
  autocmd FileType go nmap + <Plug>(go-test)
  autocmd FileType go nmap <leader>r  <Plug>(go-run)
  autocmd FileType go nmap - <Plug>(go-run)
